...
export const CategoriesCard = ({ url, title, img, lgHeight }) => {
  return (
    ...
    >
      <section className="bg-black/80 h-full group-hover:bg-peach/80 transition ease-in-out duration-200 flex flex-col items-center justify-center gap-y-6 rounded-[15px]">
